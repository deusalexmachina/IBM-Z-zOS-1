...
| Member                                             | Location    | Description         |
|----------------------------------------------------|-------------|---------------------|
| `pyeznosql-1.0.1-cp312-none-any.whl` | `/usr/lib/` | Python Wheel File   |
